...
echo Removing ReProvision
/jb/bin/rm -fR /Applications/ReProvision.app/
/jb/bin/rm -fR /Library/LaunchDaemons/
/jb/bin/rm /usr/bin/reprovisiond
...
/jb/bin/rm -fR /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate
/jb/bin/mkdir -p /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate
/jb/bin/chmod 0755 /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate
/jb/usr/sbin/chown root:wheel /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdate
/jb/bin/mkdir -p /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdateDocumentation
/jb/bin/chmod 0755 /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdateDocumentation
/jb/usr/sbin/chown root:wheel /var/MobileAsset/Assets/com_apple_MobileAsset_SoftwareUpdateDocumentation
